<?php
App::uses('View', 'View');
class RevisionEstadosOcShell extends AppShell
{
	public $uses			= array('Query', 'CompraEmailEstado');
	public $proc			= 'REVISION_ESTADOS_OC';
	public $db				= null;
	...
	public function main()
	{
		 ...
		 */
		$this->out(sprintf('Ejecutando procedimiento de revision de estados de oc %s', $this->db));
		...
		// Llamar al modelo para enviar los datos al listener
		$this->CompraEmailEstado->EnviarCorreoEntrega();
