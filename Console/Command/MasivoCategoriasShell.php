<?php
App::uses('View', 'View');
class MasivoCategoriasShell extends AppShell
{
	public $uses			= array('Query');
	public $proc			= 'MASIVO_CATEGORIAS';
	public $db				= null;
	...
	public function main()
	{
		 ...
		 */
		$this->out(sprintf('Ejecutando procedimiento de carga masiva de categorias en %s', $this->db));
