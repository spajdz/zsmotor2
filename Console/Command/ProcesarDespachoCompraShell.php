...
class ProcesarDespachoCompraShell extends AppShell
{
	...
	public function main()
	{
		 ...
		 * Obtiene la query
		 */
		$query				= $this->Query->getProductiva('LISTA_OC_PREPARACION_BODEGA');
		...
		if ( ! empty($resultados) )
		{
			foreach ( $resultados as $compra )
			{
				...
				$this->Compra->saveField('estado_compra_despacho_id', 1);
				$this->Compra->EnviarCorreoDespacho($info_compra);
			}
		}
	}
}
