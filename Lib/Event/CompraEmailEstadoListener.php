...
App::uses('View', 'View');
class CompraEmailEstadoListener implements CakeEventListener
{
	public $View				= null;
	...
	{
		return array(
			'Model.CompraEmailEstado.afterSave'	=> 'enviarEmail'
		);
	}
	...
	public function enviarEmailUsuario(CakeEvent $evento)
	{
		...
		$html						= $this->View->render('entrega_destino', 'default');
