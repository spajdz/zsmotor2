<div class="contenedor">
	<div class="row inicio">
		...
		<i class="fa fa-times icon-titulo rojo"></i><h2>Transacción rechazada para la Orden de Compra N° <?= (empty($compra['Compra']['tbk_orden_compra'])) ?  $compra['Compra']['id'] : $compra['Compra']['tbk_orden_compra']; ?></h2>
		<p>Las posibles causas de este rechazo son: </p>
			...
			<?= $this->Html->link('Volver a intentar', array('controller' => 'compras', 'action' => 'reintentar'), array('class' => 'btn')); ?>
